# P2 Auth Hybride (Frontend UI) - Validation
...
**Code ajouté** :
- `handlePasswordLogin()` : Login avec email + password
- `handleResetPasswordRequest()` : Demande reset password
- États : `loginTab`, `loginPassword`, `showResetModal`, `resetEmail`, `resetLoading`
...
**Fonctionnalités** :
- ✅ Ouverture depuis onglet "Mot de passe" (lien "Mot de passe oublié ?")
- ✅ Fermeture automatique après envoi
- ✅ Toast de confirmation (neutre)
...
**Gestion erreurs** :
- Token manquant → Toast erreur + redirection
- Token invalide/expiré → Toast erreur
- Password trop faible → Toast erreur avec message détaillé
...
**Composant créé** : `SetPasswordModal` (composant interne)
...
**Scénario** :
- Ouvrir modal login
- Onglet "Lien magique" sélectionné par défaut
- Entrer email
...
**Scénario** :
- Ouvrir modal login
- Onglet "Mot de passe" sélectionné
- Entrer email + mot de passe valide
...
**Scénario** :
- Onglet "Mot de passe"
- Entrer email + mauvais mot de passe
- Cliquer "Se connecter"
...
**Scénario** :
1. Cliquer "Mot de passe oublié ?" dans onglet password
2. Entrer email dans modal reset
3. Cliquer "Envoyer email"
4. Ouvrir lien depuis email (ou log dev)
5. Entrer nouveau mot de passe sur `/reset-password?token=...`
6. Confirmer
...
- Onglet "Mot de passe"
- Entrer email + n'importe quel password
- Cliquer "Se connecter"
...
**Scénario** :
- Se connecter avec password sur 3 appareils différents
- Vérifier sessions dans ProSettings
...
**Scénario** :
- User Pro connecté
- Aller dans ProSettings
- Section "Sécurité du compte"
- Cliquer "Définir un mot de passe"
- Entrer password + confirmation
- Cliquer "Définir le mot de passe"
...
- [x] Login Modal avec onglets créé
- [x] Reset Password Modal créé
- [x] Page Reset Password créée
- [x] Section Settings créée
- [x] Toaster ajouté dans App
- [x] Routes ajoutées (`/reset-password`)
- [x] Validation live implémentée
- [x] Toasts implémentés
- [x] Messages neutres implémentés
